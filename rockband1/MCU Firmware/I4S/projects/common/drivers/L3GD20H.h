...
typedef u8_t L3GD20H_IntPinConf_t;
...
#define L3GD20H_DRDY_PORT gpioPortA
#define L3GD20H_DRDY_PIN  10
#define L3GD20H_INT2_PORT gpioPortA
#define L3GD20H_INT2_PIN  10
...
gyrostatus_t L3GD20H_SetBDU(State_t bdu);
gyrostatus_t L3GD20H_SetBLE(L3GD20H_Endianess_t ble);
gyrostatus_t L3GD20H_SetSelfTest(L3GD20H_SelfTest_t st);
gyrostatus_t L3GD20H_SetTemperature(State_t state);
gyrostatus_t L3GD20H_SetADCAux(State_t state);

//Filtering Functions
gyrostatus_t L3GD20H_HPFClickEnable(State_t hpfe);
gyrostatus_t L3GD20H_HPFAOI1Enable(State_t hpfe);
gyrostatus_t L3GD20H_HPFAOI2Enable(State_t hpfe);
gyrostatus_t L3GD20H_SetHPFMode(L3GD20H_HPFMode_t hpf);
gyrostatus_t L3GD20H_SetHPFCutOFF(L3GD20H_HPFCutOffFreq_t hpf);
gyrostatus_t L3GD20H_SetFilterDataSel(State_t state);

//Interrupt Functions
gyrostatus_t L3GD20H_SetInt1Pin(L3GD20H_IntPinConf_t pinConf);
gyrostatus_t L3GD20H_SetInt2Pin(L3GD20H_IntPinConf_t pinConf);
gyrostatus_t L3GD20H_Int1LatchEnable(State_t latch);
gyrostatus_t L3GD20H_ResetInt1Latch(void);
gyrostatus_t L3GD20H_SetIntConfiguration(L3GD20H_Int1Conf_t ic);
gyrostatus_t L3GD20H_SetInt1Threshold(u8_t ths);
gyrostatus_t L3GD20H_SetInt1Duration(L3GD20H_Int1Conf_t id);
gyrostatus_t L3GD20H_SetIntMode(L3GD20H_Int1Mode_t ic);
gyrostatus_t L3GD20H_SetClickCFG(u8_t status);
gyrostatus_t L3GD20H_SetInt6D4DConfiguration(L3GD20H_INT_6D_4D_t ic);
gyrostatus_t L3GD20H_GetInt1Src(u8_t* val);
gyrostatus_t L3GD20H_GetInt1SrcBit(u8_t statusBIT, u8_t* val);

//FIFO Functions
gyrostatus_t L3GD20H_FIFOModeEnable(L3GD20H_FifoMode_t fm);
gyrostatus_t L3GD20H_SetWaterMark(u8_t wtm);
gyrostatus_t L3GD20H_SetTriggerInt(L3GD20H_TrigInt_t tr);
gyrostatus_t L3GD20H_GetFifoSourceReg(u8_t* val);
gyrostatus_t L3GD20H_GetFifoSourceBit(u8_t statusBIT, u8_t* val);
gyrostatus_t L3GD20H_GetFifoSourceFSS(u8_t* val);

//Other Reading Functions
gyrostatus_t L3GD20H_GetStatusReg(u8_t* val);
gyrostatus_t L3GD20H_GetStatusBit(u8_t statusBIT, u8_t* val);
gyrostatus_t L3GD20H_GetStatusAUXBit(u8_t statusBIT, u8_t* val);
gyrostatus_t L3GD20H_GetStatusAUX(u8_t* val);
gyrostatus_t L3GD20H_GetAccAxesRaw(uint8_t* buff);
gyrostatus_t L3GD20H_GetAuxRaw(L3GD20H_Aux123Raw_t* buff);
gyrostatus_t L3GD20H_GetClickResponse(u8_t* val);
gyrostatus_t L3GD20H_GetTempRaw(i8_t* val);
