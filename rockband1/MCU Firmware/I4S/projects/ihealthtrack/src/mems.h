...
status_t LIS3DH_GetAccAxesRaw(uint8_t* buff);
...
extern union _MEMS_FIFO MEMS_FIFO;

extern uint32_t save_activity_delta;
...
int MEMS_WRITE(I2C_TypeDef* i2c,
               uint8_t addr,
               TEMPSENS_Register_TypeDef reg,
               uint16_t val);
