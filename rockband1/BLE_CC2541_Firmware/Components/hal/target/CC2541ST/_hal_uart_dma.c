...
//#define DMA_RDYIn                  P0_2
#define DMA_RDYOut                 P0_5
#define DMA_RDYIn_BIT              BV(4)        // Same as the I/O Select for CTS flow control.#define DMA_RDYIn_BIT              BV(4)        // Same as the I/O Select for CTS flow control.
