...
#define IRTEMPERATURE_WRITE_BUFF_LEN    30  //20, FIXME: extended API maybe over 20
 ...
 * Variables
 */
extern uint8 irTempDataWrite[IRTEMPERATURE_WRITE_BUFF_LEN]; //the AA00:AA02 command store buffer.
extern uint8 irTempLenWrite;  //the irTempDataWrite been filled.
