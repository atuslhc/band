...
//-------------------新添加的 2015年7月7日17:39:38
//aerobic heartrate lower limit characteristic
//CONST uint8 heartRatelowerLimitUUID[ATT_BT_UUID_SIZE] =
//{ 
//  LO_UINT16(AEROBIC_HEART_LOWER_LIMIT_UUID), HI_UINT16(AEROBIC_HEART_LOWER_LIMIT_UUID)
//};
//
...
static uint8 HeartRateDataUserDesp[] = "HeartRate. Data";
#endif
// Sensor Location Characteristic
static uint8 heartRateSensLocProps = GATT_PROP_NOTIFY;
static uint8 heartRateSensLoc = 2;

//----------------------新增加一个characteristic 2015年7月7日17:35:24------------------------------
//static uint8 heartRateLowerLimitProps = GATT_PROP_NOTIFY;
//static uint8 heartRateLowerLimit      = 40;
//#if (SERVICE_DESCRIBLE_OPEN == true)
//static uint8 heartRateLowerLimitDesp[] = "HeartRate. Alert";
//#endif
...
#if (SERVICE_DESCRIBE_OPEN==TRUE)
// Heart Rate Measurement Characteristic User Description
static uint8 HeartRateLocationUserDesp[] = "HeartRate. Location";
#endif
...
gattAttribute_t heartRateAttrTbl[] = 
{
  // Heart Rate Service
  { 
...
//--------------新增加的 2015年7月7日17:37:22---------------------------------
//
//    {
//      { ATT_BT_UUID_SIZE, characterUUID },
//       GATT_PERMIT_READ, 
//       0,
//       &heartRateLowerLimitProps, 
//    },
//    
//    // aerobic heartrate lower limit
//    { 
//      { ATT_BT_UUID_SIZE, heartRatelowerLimitUUID},
//      0, 
//      0,
//      &heartRateLowerLimit 
//    },
