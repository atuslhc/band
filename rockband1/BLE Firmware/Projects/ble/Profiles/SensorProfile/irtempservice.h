...
#define IRTEMPERATURE_DATA_UUID         0xAA01  // use for download firmware
#define IRTEMPERATURE_CONF_UUID         0xAA02  // use for topdown send command (phone or dongle send command)

// Sensor Profile Services bit fields
#define IRTEMPERATURE_SERVICE           0x00000001

// Length of sensor data in bytes
#define IRTEMPERATURE_DATA_LEN          20 // 4
