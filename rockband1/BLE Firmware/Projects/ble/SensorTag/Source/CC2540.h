...
#define PRF_CHAN            XREG( 0x6000 )   /*  Frequency to use                             */
#define PRF_TASK_CONF       XREG( 0x6001 )   /*  Configuration of task control                */
#define PRF_FIFO_CONF       XREG( 0x6002 )   /*  Configure FIFO use                           */
#define PRF_PKT_CONF        XREG( 0x6003 )   /*  Packet configuration                         */
#define PRF_CRC_LEN         XREG( 0x6004 )   /*  Number of CRC bytes.                         */
#define PRF_RSSI_LIMIT      XREG( 0x6005 )   /*  For transmit on clear channel.               */
#define PRF_RSSI_COUNT      DXREG( 0x6006 )   /*  RSSI count.                                  */
#define PRF_RSSI_COUNTH     XREG( 0x6006 )   /*  RSSI count high byte.                        */
#define PRF_RSSI_COUNTL     XREG( 0x6007 )   /*  RSSI count low byte.                         */
#define PRF_CRC_INIT        PXREG( 0x6008 )   /*  Initialization value for CRC 4byte           */
#define PRF_CRC_INIT1       XREG( 0x6008 )   /*  Initialization value for CRC byte 1 MSB      */
#define PRF_CRC_INIT2       XREG( 0x6009 )   /*  Initialization value for CRC byte 2          */
#define PRF_CRC_INIT3       XREG( 0x600A )   /*  Initialization value for CRC byte 3          */
#define PRF_CRC_INIT4       XREG( 0x600B )   /*  Initialization value for CRC byte 4 LSB      */

#define PRF_W_INIT          XREG( 0x600C )   /*  */
#define PRF_RETRANS_CNT     XREG( 0x600D )   /*  Maximum number of retransmissions            */
#define PRF_TX_DELAY        DXREG( 0x600E )   /*  Delay between two tranmissions               */
#define PRF_TX_DELAYH       XREG( 0x600E )   /*  Delay between two tranmissions high byte     */
#define PRF_TX_DELAYL       XREG( 0x600F )   /*  Delay between two tranmissions low byte      */

#define PRF_RETRANS_DELAY   DXREG( 0x6010 )   /*  Delay between retranmissions                 */
#define PRF_RETRANS_DELAYH  XREG( 0x6010 )   /*  Delay between retranmissions high byte       */
#define PRF_RETRANS_DELAYL  XREG( 0x6011 )   /*  Delay between retranmissions low byte        */

#define PRF_SEARCH_TIME     DXREG( 0x6012 )   /*  Search time                                  */
#define PRF_SEARCH_TIMEH    XREG( 0x6012 )   /*  Search time high byte                        */
#define PRF_SEARCH_TIMEL    XREG( 0x6013 )   /*  Search time low byte                         */

#define PRF_RX_TX_TIME      DXREG( 0x6014 )   /*  */
#define PRF_RX_TX_TIMEH     XREG( 0x6014 )   /*  */
#define PRF_RX_TX_TIMEL     XREG( 0x6015 )   /*  */

#define PRF_TX_RX_TIME      DXREG( 0x6016 )   /*  */
#define PRF_TX_RX_TIMEH     XREG( 0x6016 )   /*  */
#define PRF_TX_RX_TIMEL     XREG( 0x6017 )   /*  */

#define PRF_ADDR_ENTRY0     PXREG( 0x6018 )   /* 12 bytes */
#define PRF_ADDR_ENTRY01    XREG( 0x6018 )   /*  */
#define PRF_ADDR_ENTRY02    XREG( 0x6019 )   /*  */
#define PRF_ADDR_ENTRY03    XREG( 0x601A )   /*  */
#define PRF_ADDR_ENTRY04    XREG( 0x601B )   /*  */
#define PRF_ADDR_ENTRY05    XREG( 0x601C )   /*  */
#define PRF_ADDR_ENTRY06    XREG( 0x601D )   /*  */
#define PRF_ADDR_ENTRY07    XREG( 0x601E )   /*  */
#define PRF_ADDR_ENTRY08    XREG( 0x601F )   /*  */
#define PRF_ADDR_ENTRY09    XREG( 0x6020 )   /*  */
#define PRF_ADDR_ENTRY0A    XREG( 0x6021 )   /*  */
#define PRF_ADDR_ENTRY0B    XREG( 0x6022 )   /*  */
#define PRF_ADDR_ENTRY0C    XREG( 0x6023 )   /*  */

#define PRF_ADDR_ENTRY1     PXREG( 0x6024 )   /* 12 bytes */
#define PRF_ADDR_ENTRY11    XREG( 0x6024 )   /*  */
#define PRF_ADDR_ENTRY12    XREG( 0x6025 )   /*  */
#define PRF_ADDR_ENTRY13    XREG( 0x6026 )   /*  */
#define PRF_ADDR_ENTRY14    XREG( 0x6027 )   /*  */
#define PRF_ADDR_ENTRY15    XREG( 0x6028 )   /*  */
#define PRF_ADDR_ENTRY16    XREG( 0x6029 )   /*  */
#define PRF_ADDR_ENTRY17    XREG( 0x602A )   /*  */
#define PRF_ADDR_ENTRY18    XREG( 0x602B )   /*  */
#define PRF_ADDR_ENTRY19    XREG( 0x602C )   /*  */
#define PRF_ADDR_ENTRY1A    XREG( 0x602D )   /*  */
#define PRF_ADDR_ENTRY1B    XREG( 0x602E )   /*  */
#define PRF_ADDR_ENTRY1C    XREG( 0x602F )   /*  */

#define PRF_ADDR_ENTRY2     PXREG( 0x6030 )   /* 12 bytes */
#define PRF_ADDR_ENTRY21    XREG( 0x6030 )   /*  */
#define PRF_ADDR_ENTRY22    XREG( 0x6031 )   /*  */
#define PRF_ADDR_ENTRY23    XREG( 0x6032 )   /*  */
#define PRF_ADDR_ENTRY24    XREG( 0x6033 )   /*  */
#define PRF_ADDR_ENTRY25    XREG( 0x6034 )   /*  */
#define PRF_ADDR_ENTRY26    XREG( 0x6035 )   /*  */
#define PRF_ADDR_ENTRY27    XREG( 0x6036 )   /*  */
#define PRF_ADDR_ENTRY28    XREG( 0x6037 )   /*  */
#define PRF_ADDR_ENTRY29    XREG( 0x6038 )   /*  */
#define PRF_ADDR_ENTRY2A    XREG( 0x6039 )   /*  */
#define PRF_ADDR_ENTRY2B    XREG( 0x603A )   /*  */
#define PRF_ADDR_ENTRY2C    XREG( 0x603B )   /*  */

#define PRF_ADDR_ENTRY3     PXREG( 0x603C )   /* 12 bytes */
#define PRF_ADDR_ENTRY31    XREG( 0x603C )   /*  */
#define PRF_ADDR_ENTRY32    XREG( 0x603D )   /*  */
#define PRF_ADDR_ENTRY33    XREG( 0x603E )   /*  */
#define PRF_ADDR_ENTRY34    XREG( 0x603F )   /*  */
#define PRF_ADDR_ENTRY35    XREG( 0x6040 )   /*  */
#define PRF_ADDR_ENTRY36    XREG( 0x6041 )   /*  */
#define PRF_ADDR_ENTRY37    XREG( 0x6042 )   /*  */
#define PRF_ADDR_ENTRY38    XREG( 0x6043 )   /*  */
#define PRF_ADDR_ENTRY39    XREG( 0x6044 )   /*  */
#define PRF_ADDR_ENTRY3A    XREG( 0x6045 )   /*  */
#define PRF_ADDR_ENTRY3B    XREG( 0x6046 )   /*  */
#define PRF_ADDR_ENTRY3C    XREG( 0x6047 )   /*  */

#define PRF_ADDR_ENTRY4     PXREG( 0x6048 )   /* 12 bytes */
#define PRF_ADDR_ENTRY41    XREG( 0x6048 )   /*  */
#define PRF_ADDR_ENTRY42    XREG( 0x6049 )   /*  */
#define PRF_ADDR_ENTRY43    XREG( 0x604A )   /*  */
#define PRF_ADDR_ENTRY44    XREG( 0x604B )   /*  */
#define PRF_ADDR_ENTRY45    XREG( 0x604C )   /*  */
#define PRF_ADDR_ENTRY46    XREG( 0x604D )   /*  */
#define PRF_ADDR_ENTRY47    XREG( 0x604E )   /*  */
#define PRF_ADDR_ENTRY48    XREG( 0x604F )   /*  */
#define PRF_ADDR_ENTRY49    XREG( 0x6050 )   /*  */
#define PRF_ADDR_ENTRY4A    XREG( 0x6051 )   /*  */
#define PRF_ADDR_ENTRY4B    XREG( 0x6052 )   /*  */
#define PRF_ADDR_ENTRY4C    XREG( 0x6053 )   /*  */

#define PRF_ADDR_ENTRY5     PXREG( 0x6054 )   /* 12 bytes */
#define PRF_ADDR_ENTRY51    XREG( 0x6054 )   /*  */
#define PRF_ADDR_ENTRY52    XREG( 0x6055 )   /*  */
#define PRF_ADDR_ENTRY53    XREG( 0x6056 )   /*  */
#define PRF_ADDR_ENTRY54    XREG( 0x6057 )   /*  */
#define PRF_ADDR_ENTRY55    XREG( 0x6058 )   /*  */
#define PRF_ADDR_ENTRY56    XREG( 0x6059 )   /*  */
#define PRF_ADDR_ENTRY57    XREG( 0x605A )   /*  */
#define PRF_ADDR_ENTRY58    XREG( 0x605B )   /*  */
#define PRF_ADDR_ENTRY59    XREG( 0x605C )   /*  */
#define PRF_ADDR_ENTRY5A    XREG( 0x605D )   /*  */
#define PRF_ADDR_ENTRY5B    XREG( 0x605E )   /*  */
#define PRF_ADDR_ENTRY5C    XREG( 0x605F )   /*  */

#define PRF_ADDR_ENTRY6     PXREG( 0x6060 )   /* 12 bytes */
#define PRF_ADDR_ENTRY61    XREG( 0x6060 )   /*  */
#define PRF_ADDR_ENTRY62    XREG( 0x6061 )   /*  */
#define PRF_ADDR_ENTRY63    XREG( 0x6062 )   /*  */
#define PRF_ADDR_ENTRY64    XREG( 0x6063 )   /*  */
#define PRF_ADDR_ENTRY65    XREG( 0x6064 )   /*  */
#define PRF_ADDR_ENTRY66    XREG( 0x6065 )   /*  */
#define PRF_ADDR_ENTRY67    XREG( 0x6066 )   /*  */
#define PRF_ADDR_ENTRY68    XREG( 0x6067 )   /*  */
#define PRF_ADDR_ENTRY69    XREG( 0x6068 )   /*  */
#define PRF_ADDR_ENTRY6A    XREG( 0x6069 )   /*  */
#define PRF_ADDR_ENTRY6B    XREG( 0x606A )   /*  */
#define PRF_ADDR_ENTRY6C    XREG( 0x606B )   /*  */

#define PRF_ADDR_ENTRY7     PXREG( 0x606C )   /* 12 bytes */
#define PRF_ADDR_ENTRY71    XREG( 0x606C )   /*  */
#define PRF_ADDR_ENTRY72    XREG( 0x606D )   /*  */
#define PRF_ADDR_ENTRY73    XREG( 0x606E )   /*  */
#define PRF_ADDR_ENTRY74    XREG( 0x606F )   /*  */
#define PRF_ADDR_ENTRY75    XREG( 0x6070 )   /*  */
#define PRF_ADDR_ENTRY76    XREG( 0x6071 )   /*  */
#define PRF_ADDR_ENTRY77    XREG( 0x6072 )   /*  */
#define PRF_ADDR_ENTRY78    XREG( 0x6073 )   /*  */
#define PRF_ADDR_ENTRY79    XREG( 0x6074 )   /*  */
#define PRF_ADDR_ENTRY7A    XREG( 0x6075 )   /*  */
#define PRF_ADDR_ENTRY7B    XREG( 0x6076 )   /*  */
#define PRF_ADDR_ENTRY7C    XREG( 0x6077 )   /*  */

#define PRF_N_TX            XREG( 0x6078 )   /*  Total number of packets transmitted          */
#define PRF_LAST_RSSI       XREG( 0x6079 )   /*  RSSI of last received packet                 */

#define PRF_LAST_DCOFF      PXREG( 0x607A )   /*  DC offset of last received packet            */
#define PRF_LAST_DCOFF1     XREG( 0x607A )   /*  DC offset of last received packet byte 1 MSB */
#define PRF_LAST_DCOFF2     XREG( 0x607B )   /*  DC offset of last received packet byte 2     */
#define PRF_LAST_DCOFF3     XREG( 0x607C )   /*  DC offset of last received packet byte 3     */
#define PRF_LAST_DCOFF4     XREG( 0x607D )   /*  DC offset of last received packet byte 4 LSB */

#define PRF_RADIO_CONF      XREG( 0x607E )   /*  Configure radio hardware                     */
#define PRF_ENDCAUSE        XREG( 0x607F )   /*  Reason why LLE ended task                    */
...
#define PRFX_TONE_DURATIONH       XREG( 0x600C )   /*  */ 
#define PRFX_TONE_DURATIONL       XREG( 0x600D )   /*  */ 

#define PRFX_TONE_OFFSETH         XREG( 0x600E )   /*  */ 
#define PRFX_TONE_OFFSETL         XREG( 0x600F )   /*  */ 

/*            XREG Registers                                                    */
#define FRMCTRL0                  XREG( 0x6180 )   /*  */
#define RFIRQM0                   XREG( 0x6181 )   /* RF Interrupt Masks                      */
#define RFIRQM1                   XREG( 0x6182 )   /* RF Interrupt Masks                      */
#define RFERRM                    XREG( 0x6183 )   /* RF Error Interrupt Masks                */
#define FREQCTRL                  XREG( 0x6184 )   /* Synth Frequency Control                 */
#define FREQTUNE                  XREG( 0x6185 )   /* Crystal Oscillator Frequency Tuning     */
#define TXPOWER                   XREG( 0x6186 )   /* Output Power Control                    */
#define TXCTRL                    XREG( 0x6187 )   /* Tx Settings                             */
#define LLESTAT                   XREG( 0x6188 )   /* LLE Status                              */
#define SEMAPHORE0                XREG( 0x618A )   /* Semaphore0 for Accessing RF Data Memory */
#define SEMAPHORE1                XREG( 0x618B )   /* Semaphore1 for Accessing RF Data Memory */
#define SEMAPHORE2                XREG( 0x618C )   /* Semaphore2 for Accessing RF Data Memory */
#define RFSTAT                    XREG( 0x618D )   /* RF Core Status                          */
#define RSSI                      XREG( 0x618E )   /* Received Signal Strength Indicator      */
#define RFPSRND                   XREG( 0x618F )   /* Pseudo-Random Number Generator          */
#define MDMCTRL0                  XREG( 0x6190 )   /* Modem Configuration                     */
#define MDMCTRL1                  XREG( 0x6191 )   /* Modem Configuration                     */
#define MDMCTRL2                  XREG( 0x6192 )   /* Modem Configuration                     */
#define MDMCTRL3                  XREG( 0x6193 )   /* Modem Configuration                     */
#define SW_CONF                   XREG( 0x6194 )   /* Sync Word Configuration                 */
#define SW0                       XREG( 0x6195 )   /* Primary Sync Word Byte 0                */
#define SW1                       XREG( 0x6196 )   /* Primary Sync Word Byte 1                */
#define SW2                       XREG( 0x6197 )   /* Primary Sync Word Byte 2                */
#define SW3                       XREG( 0x6198 )   /* Primary Sync Word Byte 3                */
#define FREQEST                   XREG( 0x6199 )   /* Estimated RF Frequency Offset           */
#define RXCTRL                    XREG( 0x619A )   /* Receive Section Tuning                  */
#define FSCTRL                    XREG( 0x619B )   /* Frequency Synthesizer Tuning            */
#define LNAGAIN                   XREG( 0x61A0 )   /* LNA Gain Setting                        */
#define AAFGAIN                   XREG( 0x61A1 )   /* AAF Gain Setting                        */
#define ADCTEST0                  XREG( 0x61A2 )   /* ADC Tuning                              */
#define MDMTEST0                  XREG( 0x61A5 )   /* Modem Configuration                     */
#define MDMTEST1                  XREG( 0x61A6 )   /* Modem Configuration                     */
#define ATEST                     XREG( 0x61A9 )   /* Analog Test Control                     */

#define RFC_OBS_CTRL0             XREG( 0x61AE )   /* RF Observation Mux Control 0            */
#define RFC_OBS_CTRL1             XREG( 0x61AF )   /* RF Observation Mux Control 1            */
#define RFC_OBS_CTRL2             XREG( 0x61B0 )   /* RF Observation Mux Control 2            */
#define LLECTRL                   XREG( 0x61B1 )   /* LLE Control                             */
#define ACOMPQS                   XREG( 0x61B6 )   /* Quadrature Skew Setting                 */
#define TXFILTCFG                 XREG( 0x61BC )   /* TX Filter Configuration                 */
#define RFRND                     XREG( 0x61BF )   /* Random Data                             */
#define RFRAMCFG                  XREG( 0x61C0 )   /* Radio RAM Configuration                 */
                                                   /* PRE:bit2:0 page number                  */
#define RFFDMA0                   XREG( 0x61C3 )   /* Radio DMA Trigger 0 Control             */
#define RFFDMA1                   XREG( 0x61C4 )   /* Radio DMA Trigger 1 Control             */
#define RFFSTATUS                 XREG( 0x61C5 )   /* FIFO Status                             */
#define RFFCFG                    XREG( 0x61C6 )   /* FIFO Configuration                      */
#define RFRXFLEN                  XREG( 0x61C8 )   /* Rx FIFO Length                          */
#define RFRXFTHRS                 XREG( 0x61C9 )   /* Rx FIFO Threshold                       */
#define RFRXFWR                   XREG( 0x61CA )   /* Rx FIFO Write Register                  */
#define RFRXFRD                   XREG( 0x61CB )   /* Rx FIFO Read Register                   */
#define RFRXFWP                   XREG( 0x61CC )   /* Rx FIFO Write Pointer                   */
#define RFRXFRP                   XREG( 0x61CD )   /* Rx FIFO Read Pointer                    */
#define RFRXFSWP                  XREG( 0x61CE )   /* Rx FIFO Start-of-Frame Write Pointer    */
#define RFRXFSRP                  XREG( 0x61CF )   /* Rx FIFO Start-of-Frame Read Pointer     */
#define RFTXFLEN                  XREG( 0x61D0 )   /* Tx FIFO Length                          */
#define RFTXFTHRS                 XREG( 0x61D1 )   /* Tx FIFO Threshold                       */
#define RFTXFWR                   XREG( 0x61D2 )   /* Tx FIFO Write Register                  */
#define RFTXFRD                   XREG( 0x61D3 )   /* Tx FIFO Read Register                   */
#define RFTXFWP                   XREG( 0x61D4 )   /* Tx FIFO Write Pointer                   */
#define RFTXFRP                   XREG( 0x61D5 )   /* Tx FIFO Read Pointer                    */
#define RFTXFSWP                  XREG( 0x61D6 )   /* Tx FIFO Start-of-Frame Write Pointer    */
#define RFTXFSRP                  XREG( 0x61D7 )   /* Tx FIFO Start-of-Frame Read Pointer     */
#define BSP_P0                    XREG( 0x61E0 )   /* CRC Polynomial Byte 0                   */
#define BSP_P1                    XREG( 0x61E1 )   /* CRC Polynomial Byte 1                   */
#define BSP_P2                    XREG( 0x61E2 )   /* CRC Polynomial Byte 2                   */
#define BSP_P3                    XREG( 0x61E3 )   /* CRC Polynomial Byte 3                   */
#define BSP_D0                    XREG( 0x61E4 )   /* CRC Value Byte 0                        */
#define BSP_D1                    XREG( 0x61E5 )   /* CRC Value Byte 1                        */
#define BSP_D2                    XREG( 0x61E6 )   /* CRC Value Byte 2                        */
#define BSP_D3                    XREG( 0x61E7 )   /* CRC Value Byte 3                        */
#define BSP_W                     XREG( 0x61E8 )   /* Whitener Value                          */
#define BSP_MODE                  XREG( 0x61E9 )   /* Bit Stream Processor Configuration      */
#define BSP_DATA                  XREG( 0x61EA )   /* Bit Stream Processor Co-Processor Data  */
#define SW4                       XREG( 0x61F8 )   /* Secondary Sync Word Byte 0              */
#define SW5                       XREG( 0x61F9 )   /* Secondary Sync Word Byte 1              */
#define SW6                       XREG( 0x61FA )   /* Secondary Sync Word Byte 2              */
#define SW7                       XREG( 0x61FB )   /* Secondary Sync Word Byte 3              */
#define DC_I_L                    XREG( 0x61FC )   /* In-Phase DC Offset Estimate Low Byte    */
#define DC_I_H                    XREG( 0x61FD )   /* In-Phase DC Offset Estimate High Byte   */
#define DC_Q_L                    XREG( 0x61FE )   /* Quadrature-Phase DC Offset Estimate Low Byte  */
#define DC_Q_H                    XREG( 0x61FF )   /* Quadrature-Phase DC Offset Estimate High Byte */
...
/* Op.Amp. Control */
#define OPAMPMC         XREG( 0x61AD )   /* Operational amplifier mode control      */
