...
//			GAP_UpdateAdvertisingData( sensorTag_TaskID, TRUE,
//			                           15, (uint8*)advertData );
    GAPRole_SetParameter( GAPROLE_ADVERT_DATA, 15, advertData ); //Atus: Why len=15?
		}
	***********************************************************************/
  }
}
