...
#define ACCELEROMETER_DATA_UUID         0xAA11  //向APP发送响应或数据。
#define ACCELEROMETER_CONF_UUID         0xAA12
#define ACCELEROMETER_PERI_UUID         0xAA13
  
#if 0
#define HEART_ALERT_CHAR_UUID           0xAA14	// Add a new characteristic (for test only)
#endif
...
#define ACCELEROMETER_DATA_LEN          20////3
...
//----------------新加的 
#define HEARTRATE_ALERT_NOTI_ENABLED         1
#define HEARTRATE_ALERT_NOTI_DISABLED        2
   
   // accelero Service callback function
typedef void (*accelerometerServiceCB_t)(uint8 event);
/*********************************************************************
 * TYPEDEFS
 */
...
extern bStatus_t acc_HeartAlertNotify( uint16 connHandle, attHandleValueNoti_t* pNoti );
/*********************************************************************
*********************************************************************/
